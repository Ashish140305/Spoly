    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans relative overflow-hidden selection:bg-blue-300 selection:text-blue-900">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-white/60 backdrop-blur-xl border border-white/80 shadow-xl rounded-[2.5rem] p-8 md:p-12 space-y-8 text-slate-700 leading-relaxed">
            <p className="text-lg font-medium text-slate-500">Last updated: {new Date().toLocaleDateString()}</p>
            
            <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">1. Data Collection & Audio Processing</h2>
                <p>Spoly requires access to your microphone and system audio to generate transcripts and diagrams. Audio files uploaded or recorded via our service are processed securely. <strong>We do not store your raw audio data</strong> after the transcription and formatting processes are successfully completed.</p>
            </section>

            <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">2. AI Model Training</h2>
                <p>We strictly respect your intellectual property. <strong>We do not use your personal meeting transcripts, code snippets, or generated diagrams to train our foundational AI models.</strong> Your data remains private to your workspace.</p>
            </section>

            <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Data Security</h2>
                <p>All data transmitted between your browser and our servers is encrypted in transit using industry-standard TLS. Data at rest (such as your saved notes and diagrams) is encrypted within our database.</p>
            </section>

            <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">4. Third-Party Services</h2>
                <p>We use trusted third-party providers (such as Clerk for authentication). These services only receive the data strictly necessary to perform their functions and are bound by stringent confidentiality agreements.</p>
            </section>

            <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Contact Us</h2>
                <p>If you have any questions about how your data is handled, please contact our security team at <a href="mailto:privacy@spoly.app" className="text-blue-600 font-bold hover:underline">privacy@spoly.app</a>.</p>
            </section>
        </div>
      </div>
    </div>
